...
function SmurfForm() {
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <input type="text" id="height" name="height" value={formValues.height} onChange={handleChange}/>
            <label htmlFor="age">Smurf Age</label>
            <input type="text" id="age" name="age" value={formValues.age} onChange={handleChange}/>
